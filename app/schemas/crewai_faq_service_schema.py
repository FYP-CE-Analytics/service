...
class CrewAIAnalysisRunOutputSchema(BaseModel):
    """
    Schema for CrewAI Analysis Run Output
    """
    report: str = Field(
        ...,
        title="Report",
        description="The report generated by the Analysis task."
    )
    questions: List[QuestionClusterSchema] = Field(
        ...,
        title="Questions",
        description="List of question clusters identified by the Analysis task."
    )
